...
- Create mode no longer follows a symlinked target that resolves outside the mount. ([#92](https://github.com/rcrsr/rill-ext/issues/92), [#102](https://github.com/rcrsr/rill-ext/pull/102))
