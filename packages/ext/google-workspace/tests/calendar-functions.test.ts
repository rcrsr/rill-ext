...
const ALL_CAPS_CONFIG = {
  ...
  capabilities: {
    gmail: { read: true, search: true, send: true, draft: true, reply: true, label: true, modify: true },
    drive: { read: true, list: true, upload: true, download: true, share: true, delete: true },
    calendar: { read: true, create: true, update: true, delete: true, freeBusy: true },
  },
};
...
const NO_CAL_CONFIG = {
  ...
  capabilities: {
    gmail: { read: true, search: true, send: true, draft: true, reply: true, label: true, modify: true },
    drive: { read: true, list: true, upload: true, download: true, share: true, delete: true },
    calendar: { read: false, create: false, update: false, delete: false, freeBusy: false },
  },
};
...
const SAMPLE_EVENT_ITEM = {
  ...
  attendees: [{ email: 'a@x.com', displayName: 'Alice', responseStatus: 'accepted' }],
