...
- Tool calls send the server's original schema keys instead of the sanitized names; rill scripts still call with sanitized snake_case names. ([#90](https://github.com/rcrsr/rill-ext/issues/90), [#102](https://github.com/rcrsr/rill-ext/pull/102))
