...
| | [`rill-ext-google-workspace`](packages/ext/google-workspace) | [![npm](https://img.shields.io/npm/v/@rcrsr/rill-ext-google-workspace)](https://www.npmjs.com/package/@rcrsr/rill-ext-google-workspace) | [docs](packages/ext/google-workspace/docs/README.md) | Google Workspace (Gmail, Drive, Calendar) |
